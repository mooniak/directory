...
export default function Community() {
  return (
    <div className="max-xl2:container xl:pl-[5%] xl:pr-[5%]">
      ...
      <div className="grid lg:grid-cols-2 lg:p-16 pt-10 pb-10 items-center xl:container ">
        <div>
          <h1
      ...
      <div className="lg:p-10 pt-5 pb-5 xl:container grid lg:grid-cols-2 items-center lg:gap-0 gap-10">
        <div>
          <span className="font-bold text-[36px]">Join the Community</span>
          <p>
            Let us know your interest by filling the form.
            {' '}
            <br />
            {' '}
            follow the
        ...
        <div>
          <Button variant="outline" className="rounded-full gap-5 p-5">
            To the form
            {' '}
            <MoveRight size={25} strokeWidth={1.25} />
          </Button>
        </div>
      </div>
