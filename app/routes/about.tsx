...
export default function About() {
  return (
    <div className="max-xl:container xl:pl-[5%] xl:pr-[5%]">
      ...
      <div className="py-10 grid lg:grid-cols-2 gap-10 xl:container">
        <div className="pt-5 pb-5 flex justify-center lg:justify-start">
          <svg
            className="lg:w-[543px] w-[70vw]"
            viewBox="0 0 543 511"
            fill="none"
        ...
        <h2 className="text-[50px] sm:hidden block pt-10">
          Mooniak:
          {' '}
          <br />
        ...
        <div
          className="lg:w-[90%] sm:text-[20px]"
          style={{
      ...
      <div className="grid xl:grid-cols-2 sm:pb-20 pb-10 xl:container">
        <div>
          <div className="sm:pt-20 pt-10 sm:pb-20 pb-10">
            <span className=" font-bold text-start text-[26px] xl:block hidden">
              A Brief History
              {' '}
              <br />
              of a Foundry
            </span>
            <span className=" text-start text-[26px] xl:hidden block">
              A Brief History
            </span>
          </div>

          <p className="text-[18px] lg:w-[80%] ">
        ...
        <div className="pt-[1px] max-xl:hidden">
          <div className="grid grid-rows-2">
            <div>
              <img
                src="/about/about_book.png"
                alt="about_book"
                className="w-[864px] h-[549px]"
              />
            </div>
            <div className="bg-black">
              <img src="/about/about_books.png" alt="about_books" className="pt-10" />
            </div>
          </div>
        </div>
      </div>
