...
export default function Contact() {
  ...
  return (
    <div className="max-xl:container xl:pl-[5%] xl:pr-[5%]">
      ...
      <div className="container grid lg:grid-cols-2 items-center justify-center sm:pt-16 pt-10 sm:pb-16">
        <div className="justify-center flex">
          <svg
            className="w-auto h-auto p-5 lg:w-[478px] lg:h-[140px]"
            viewBox="0 0 475 139"
            fill="none"
        ...
        <span className="sm:text-[28px] text-[20px] lg:w-[504px] lg:h-[200px] w-auto h-auto lg:text-start sm:pt-10 lg:pt-0 mb-10">
          Looking to get a high quality type-work done? or Interested in
          collaborating with us on a project? We are interested too...
          {' '}
          <br />
          {' '}
      ...
      <div className="grid lg:grid-cols-2 lg:container">
        <div className="flex items-center">
          <div className="w-[100%] pt-20 pb-20 lg:pr-40">
        ...
        <Separator className="lg:hidden block container p-0" />

        <div className="flex lg:p-20">
          <div className="lg:w-[60%] w-[100%] lg:pt-0 pt-10">
            <span className="font-bold text-[22px]">
              Get
              <br />
              {' '}
            ...
            <div className="space-y-2 pt-10">
              ...
              <div className="flex items-center gap-10">
                ...
                <Link
                  ...
                  to={`https://wa.me//+94${phoneNoWithoutSpaces}`}
                >
                  {PHONE_NO}
                </Link>
              </div>
