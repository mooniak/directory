...
export function HomeHeader() {
  return (
    <div className="grid lg2:grid-cols-12 lg:grid-cols-12 sm2:grid-cols-2 pt-2 pb-2 ">
      <div className="font-bold gap-[20px] sm2:flex text-left sm2:items-center  sm2:col-start-1 sm2:col-end-6 col-start-2 col-end-3 row-span-3 text-lg sm2:text-sm2 text-xl">
